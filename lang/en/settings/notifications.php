...
return [
    ...
    'apprise_direct_urls' => 'Direct URLs',
    'apprise_config_tags' => 'Tags',
    'apprise_config_key' => 'Config Key',
    'apprise_config_key_helper' => 'Enter the config key from your Apprise server stateful configuration.',
    'apprise_tags' => 'Tags',
    'apprise_tags_helper' => 'Tags for filtering notifications. Type a tag and press Enter, comma, or Tab to add it. These tags determine which configured services receive the notification.',
    'apprise_channels' => 'Channel URLs',
    ...
    'apprise_channel_url_helper' => 'Provide the service endpoint URL for notifications. Can be used independently or alongside config key + tags.',

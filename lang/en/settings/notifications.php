...
return [
    ...
    'apprise_server_url_helper' => 'Enter your Apprise server URL. For stateless mode use /notify endpoint. For persistent configs include the config key (e.g., http://localhost:8000/cfg/my-config).',
